...
class FCN16s(nn.Module):
	...
	init.kaiming_normal(self.linear.weight.data, a=0, mode='fan_out')
	init.constant(self.linear.bias.data, 0.0)

        # conv1
        self.conv1_1 = nn.Conv2d(128, 64, (1,3), padding=(0,100))
	init.kaiming_normal(self.conv1_1.weight.data, a=0, mode='fan_in') 
	self.bnorm1_1 = nn.BatchNorm2d(64)
	init.normal(self.bnorm1_1.weight.data, 1.0, 0.02)
	init.constant(self.bnorm1_1.bias.data, 0.0)
        self.relu1_1 = nn.Tanh()
        self.conv1_2 = nn.Conv2d(64, 64, (1,3), padding=(0,1))
	init.kaiming_normal(self.conv1_2.weight.data, a=0, mode='fan_in') 
        self.bnorm1_2 = nn.BatchNorm2d(64)
	init.normal(self.bnorm1_2.weight.data, 1.0, 0.02)
	init.constant(self.bnorm1_2.bias.data, 0.0)
	...
	init.kaiming_normal(self.conv2_1.weight.data, a=0, mode='fan_in')
        self.bnorm2_1 = nn.BatchNorm2d(128)
	init.normal(self.bnorm2_1.weight.data, 1.0, 0.02)
	init.constant(self.bnorm2_1.bias.data, 0.0)
        self.relu2_1 = nn.Tanh()
        self.conv2_2 = nn.Conv2d(128, 128, (1,3), padding=(0,1))
	init.kaiming_normal(self.conv2_2.weight.data, a=0, mode='fan_in')
        self.bnorm2_2 = nn.BatchNorm2d(128)
	init.normal(self.bnorm2_2.weight.data, 1.0, 0.02)
	init.constant(self.bnorm2_2.bias.data, 0.0)
	...
	init.kaiming_normal(self.conv3_1.weight.data, a=0, mode='fan_in')
        self.bnorm3_1 = nn.BatchNorm2d(256)
	init.normal(self.bnorm3_1.weight.data, 1.0, 0.02)
	init.constant(self.bnorm3_1.bias.data, 0.0)
        self.relu3_1 = nn.Tanh()
        self.conv3_2 = nn.Conv2d(256, 256, (1,3), padding=(0,1))
	init.kaiming_normal(self.conv3_2.weight.data, a=0, mode='fan_in')
        self.bnorm3_2 = nn.BatchNorm2d(256)
	init.normal(self.bnorm3_2.weight.data, 1.0, 0.02)
	init.constant(self.bnorm3_2.bias.data, 0.0)
        self.relu3_2 = nn.Tanh()
        self.conv3_3 = nn.Conv2d(256, 256, (1,3), padding=(0,1))
	init.kaiming_normal(self.conv3_3.weight.data, a=0, mode='fan_in')
        self.bnorm3_3 = nn.BatchNorm2d(256)
	init.normal(self.bnorm3_3.weight.data, 1.0, 0.02)
	init.constant(self.bnorm3_3.bias.data, 0.0)
	...
	init.kaiming_normal(self.conv4_1.weight.data, a=0, mode='fan_in')
        self.bnorm4_1 = nn.BatchNorm2d(512)
	init.normal(self.bnorm4_1.weight.data, 1.0, 0.02)
	init.constant(self.bnorm4_1.bias.data, 0.0)
        self.relu4_1 = nn.Tanh()
        self.conv4_2 = nn.Conv2d(512, 512, (1,3), padding=(0,1))
	init.kaiming_normal(self.conv4_2.weight.data, a=0, mode='fan_in')
        self.bnorm4_2 = nn.BatchNorm2d(512)
	init.normal(self.bnorm4_2.weight.data, 1.0, 0.02)
	init.constant(self.bnorm4_2.bias.data, 0.0)
        self.relu4_2 = nn.Tanh()
        self.conv4_3 = nn.Conv2d(512, 512, (1,3), padding=(0,1))
	init.kaiming_normal(self.conv4_3.weight.data, a=0, mode='fan_in')
        self.bnorm4_3 = nn.BatchNorm2d(512)
	init.normal(self.bnorm4_3.weight.data, 1.0, 0.02)
	init.constant(self.bnorm4_3.bias.data, 0.0)
	...
	init.kaiming_normal(self.conv5_1.weight.data, a=0, mode='fan_in')
        self.bnorm5_1 = nn.BatchNorm2d(512)
	init.normal(self.bnorm5_1.weight.data, 1.0, 0.02)
	init.constant(self.bnorm5_1.bias.data, 0.0)
        self.relu5_1 = nn.Tanh()
        self.conv5_2 = nn.Conv2d(512, 512, (1,3), padding=(0,1))
	init.kaiming_normal(self.conv5_2.weight.data, a=0, mode='fan_in')
        self.bnorm5_2 = nn.BatchNorm2d(512)
	init.normal(self.bnorm5_2.weight.data, 1.0, 0.02)
	init.constant(self.bnorm5_2.bias.data, 0.0)
        self.relu5_2 = nn.Tanh()
        self.conv5_3 = nn.Conv2d(512, 512, (1,3), padding=(0,1))
	init.kaiming_normal(self.conv5_3.weight.data, a=0, mode='fan_in')
        self.bnorm5_3 = nn.BatchNorm2d(512)
	init.normal(self.bnorm5_3.weight.data, 1.0, 0.02)
	init.constant(self.bnorm5_3.bias.data, 0.0)
        self.relu5_3 = nn.Tanh()
        self.pool5 = nn.MaxPool2d((1,2), stride=(1,2), ceil_mode=True)  # 1/32

        # fc6
        self.fc6 = nn.Conv2d(512, 4096, (1,7))
	init.kaiming_normal(self.fc6.weight.data, a=0, mode='fan_in')
        self.relu6 = nn.Tanh()
        self.drop6 = nn.Dropout2d()

        # fc7
        self.fc7 = nn.Conv2d(4096, 4096, (1,1))
	init.kaiming_normal(self.fc7.weight.data, a=0, mode='fan_in')
        self.relu7 = nn.Tanh()
        self.drop7 = nn.Dropout2d()

        self.score_fr = nn.Conv2d(4096, n_class, (1,1))
	init.kaiming_normal(self.score_fr.weight.data, a=0, mode='fan_in')
        self.score_fr_bn = nn.BatchNorm2d(n_class)
        self.score_pool4 = nn.Conv2d(512, n_class, (1,1))
	init.kaiming_normal(self.score_pool4.weight.data, a=0, mode='fan_in')
	...
	init.kaiming_normal(self.classifierLayer.weight.data, a=0, mode='fan_out')
	init.constant(self.classifierLayer.bias.data, 0.0)
